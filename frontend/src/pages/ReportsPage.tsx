    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                >
                  ...
                  <option value="Mumbai Central Flagship">Mumbai Central Flagship</option>
                  <option value="Delhi Select Citywalk">Delhi Select Citywalk</option>
                  <option value="Bengaluru Indiranagar">Bengaluru Indiranagar</option>
                  <option value="Pune Phoenix Marketcity">Pune Phoenix Marketcity</option>
                </select>
              </div>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {/* Scheduled Automated Reports Box */}
          <div className="bg-slate-950 text-white rounded-2xl p-6 border border-slate-800 shadow-sm space-y-3">
            <h3 className="text-xs font-bold uppercase tracking-wider text-[#00E676] flex items-center gap-2">
              <Clock className="w-4 h-4" />
              <span>Automated Schedule Recurrence</span>
            </h3>
            <p className="text-xs text-slate-400">
              System generates and emails periodic briefs directly to Store Managers and System Admins.
            </p>

            <div className="space-y-2 pt-1 text-xs">
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-between">
                <div>
                  <p className="font-bold">Weekly Merchandising Executive Summary</p>
                  <span className="text-[10px] text-slate-400">Every Monday at 08:00 AM • PDF Format</span>
                </div>
                <span className="text-[10px] bg-[#00E676]/20 text-[#00E676] px-2 py-0.5 rounded-full font-bold border border-[#00E676]/30">
                  Active Schedule
                </span>
              </div>
              ...
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-between">
                <div>
                  <p className="font-bold">Daily Camera Sensor Offline Telemetry</p>
                  <span className="text-[10px] text-slate-400">Daily at 11:59 PM • CSV Format</span>
                </div>
                <span className="text-[10px] bg-[#00E676]/20 text-[#00E676] px-2 py-0.5 rounded-full font-bold border border-[#00E676]/30">
                  Active Schedule
                </span>
