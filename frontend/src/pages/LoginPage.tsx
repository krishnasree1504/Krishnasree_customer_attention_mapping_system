          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] text-slate-400">One-click role test</span>
              </div>
              <div className="grid grid-cols-3 gap-2">
                <button
                  type="button"
                  onClick={() => handleQuickLogin('admin@cams.com', 'admin123')}
                  disabled={isLoading}
                  className="py-2.5 px-2 rounded-xl bg-purple-50 border border-purple-200 hover:bg-purple-100 text-purple-900 text-xs font-bold transition-all text-center flex flex-col items-center justify-center gap-0.5 shadow-sm cursor-pointer"
                >
                  <span>Admin</span>
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('manager@cams.com', 'manager123')}
                  disabled={isLoading}
                  className="py-2.5 px-2 rounded-xl bg-blue-50 border border-blue-200 hover:bg-blue-100 text-blue-900 text-xs font-bold transition-all text-center flex flex-col items-center justify-center gap-0.5 shadow-sm cursor-pointer"
                >
                  <span>Store Mgr</span>
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('analyst@cams.com', 'analyst123')}
                  disabled={isLoading}
                  className="py-2.5 px-2 rounded-xl bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 text-[#008A3E] text-xs font-bold transition-all text-center flex flex-col items-center justify-center gap-0.5 shadow-sm cursor-pointer"
                >
                  <span>Analyst</span>
