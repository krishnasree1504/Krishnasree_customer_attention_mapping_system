...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* KPI Metrics Grid (10 Required KPI Cards) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
        ...
        <MetricCard
          ...
          value={activeCameras}
          trend={{ value: `${Math.round((activeCameras / totalCameras) * 100)}% Uptime` }}
          icon={<CheckCircle className="w-5 h-5 text-[#008A3E]" />}
          subtitle="Live Transmitting"
        />
        <MetricCard
          ...
          subtitle="Signal Offline"
        />
        <MetricCard
          title="Store Managers"
          value={storeManagersCount}
        ...
        <MetricCard
          ...
          value={totalConsumersToday}
          trend={{ value: '+12.4% YoY' }}
          icon={<Eye className="w-5 h-5" />}
          subtitle="24h Visitor Count"
        />
        <MetricCard
          title="Total Footfall"
          value={totalFootfall}
          trend={{ value: 'Cumulative' }}
          icon={<TrendingUp className="w-5 h-5" />}
          subtitle="Shopper Volume"
        />
        <MetricCard
          title="Avg Attention Score"
          value={avgAttentionScore}
          trend={{ value: '+3.2% vs Target' }}
          icon={<Activity className="w-5 h-5" />}
          subtitle="Store Engagement Index"
        />
      </div>
