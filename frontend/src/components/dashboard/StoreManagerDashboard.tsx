    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <MetricCard
          ...
          trend={{ value: `${displayCameras.length} Total` }}
          icon={<CheckCircle className="w-5 h-5 text-[#008A3E]" />}
          subtitle="Transmitting Feeds"
        />
        <MetricCard
          title="Offline Cameras"
          value={offlineCamerasCount}
          trend={{ value: offlineCamerasCount > 0 ? 'Action Needed' : 'All Online', isPositive: offlineCamerasCount === 0 }}
